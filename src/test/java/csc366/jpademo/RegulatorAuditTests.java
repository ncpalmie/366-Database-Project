...
// RegulatorAuditTests: Add, list, and remove Regulator & Audit instances
...
public class RegulatorAuditTests {

    private final static Logger log = LoggerFactory.getLogger(RegulatorAuditTests.class);
