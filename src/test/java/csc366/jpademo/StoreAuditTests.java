...
// StoreAuditTests: Add, list, and remove Store & Audit instances
...
public class StoreAuditTests {

    private final static Logger log = LoggerFactory.getLogger(StoreAuditTests.class);
